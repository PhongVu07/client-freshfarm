          ...
          <div className="my-account-session col-md-10">
            ...
            <div className="my-account-profile">
              <div className="my-account-profile-left">
                ...
                {currentUser && currentUser.store_name ? (
                  <div className="mb-5">
                    <div className="input-with-lable-wrapper">
                      <div className="input-with-lable-lable">Store Name</div>
                      <div className="input-with-lable-content">
                        <input
                          type="text"
                          className="input-with-lable-content"
                          defaultValue={currentUser && currentUser.store_name}
                          onChange={e =>
                            setCurrentUser({
                              ...currentUser,
